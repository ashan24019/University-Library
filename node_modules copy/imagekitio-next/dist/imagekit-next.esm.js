...
const IKImage = props => {
  ...
  return currentUrl != undefined && Object.keys(imageProps).length ? React.createElement(NextImage, Object.assign({
    loader: ({
      src
    }) => src,
    alt: alt,
  ...
  }, imageProps)) : React.createElement("img", Object.assign({
    src: currentUrl ? currentUrl : undefined,
    ref: imageRef
  }, restPropsWithoutImageProps));
};

const IKUpload = forwardRef((props, ref) => {
  ...
  return React.createElement("input", Object.assign({}, restProps, {
    ref: ref,
    type: "file",
    onChange: e => {
...
const IKVideo = props => {
  ...
  return React.createElement("video", Object.assign({}, restProps, {
    ref: videoRef,
    key: currentUrl
...
export { IKImage, IKUpload, IKVideo, ImageKit as ImageKitClient, ImageKitContext, ImageKitProvider };
